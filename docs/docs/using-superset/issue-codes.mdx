...
```
ZainDash encountered an error while running a command.
```

Something unexpected happened, and ZainDash encountered an error while
running a command. Please reach out to your administrator.

## Issue 1011

```
ZainDash encountered an unexpected error.
```
