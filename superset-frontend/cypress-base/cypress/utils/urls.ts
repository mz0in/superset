...
export const WORLD_HEALTH_DASHBOARD = '/zaindash/dashboard/world_health/';
export const SAMPLE_DASHBOARD_1 = '/zaindash/dashboard/1-sample-dashboard/';
export const SUPPORTED_CHARTS_DASHBOARD =
  '/zaindash/dashboard/supported_charts_dash/';
export const TABBED_DASHBOARD = '/zaindash/dashboard/tabbed_dash/';
