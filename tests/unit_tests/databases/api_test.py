        ...
        "errors": [
            {
                ...
                "extra": {
                    "issue_codes": [
                        {
                            "code": 1010,
                            "message": "Issue 1010 - ZainDash encountered an error while running a command.",  # noqa: E501
                        }
                    ]
                },
            }
        ...
        "errors": [
            {
                ...
                "extra": {
                    "issue_codes": [
                        {
                            "code": 1011,
                            "message": "Issue 1011 - ZainDash encountered an unexpected error.",  # noqa: E501
                        },
                        {
                            "code": 1036,
