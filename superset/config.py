...
# Default value of None will take you to '/zaindash/welcome'
# You can also specify a relative URL e.g. '/zaindash/welcome' or '/dashboards/list'
...
EMAIL_REPORTS_CTA = "Explore in ZenData"
